...
var indian_wolf_almanac = preload("res://Assets/Scences/UI/Wolf_Almanac/Book/Indian Wolf/indian_wolf_almanac.tscn").instantiate()
...
func _on_area_2d_body_entered(body):
	if body as Players:
		...
		if howling.finished:
			...
			get_wolf.play()
		WolfData._set_Indian_Wolf_Rescue_Status(true)
		#Image
		...
		get_tree().change_scene_to_packed(indian_wolf_almanac)
		get_tree().root.add_child(indian_wolf_almanac)
