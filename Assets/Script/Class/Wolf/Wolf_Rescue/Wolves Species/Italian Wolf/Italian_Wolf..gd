...
func _on_area_2d_body_entered(body):
	if body.is_in_group("player"):
		...
		if howling.finished:
			...
			get_wolf.play()
		WolfData._set_Italian_Wolf_Rescue_Status(true)
		#Image
		...
		#Height
		almanac.setter_Wolf_Height(WolfData._get_Italian_Wolf_Height())
		#Weight
		almanac.setter_Wolf_Weight(WolfData._get_Italian_Wolf_Weight())
		#Lenght
		almanac.setter_Wolf_Lenght(WolfData._get_Italian_Wolf_Lenght())
		#Conservation Status
		almanac.setter_Wolf_Conservation_Status(WolfData._get_Italian_Wolf_Conservation_Status())
		#Region
		almanac.setter_Wolf_Region(WolfData._get_Italian_Wolf_Location())
		#Morphology
		almanac.setter_Wolf_Morphology(WolfData._get_Italian_Wolf_Morphology())
		#Diets
		almanac.setter_Wolf_Diets(WolfData._get_Italian_Wolf_Diets())
