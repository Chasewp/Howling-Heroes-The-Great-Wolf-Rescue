class_name Alaskan_Tundra_Wolf
...
var alaskan_tundra_wolf_almanac = preload("res://Assets/Scences/UI/Wolf_Almanac/Book/Alaska Tundra Wolf/alaskan_tundra_wolf_almanac.tscn").instantiate()
...
func _on_area_2d_body_entered(body):
	if body.is_in_group("player"):
		...
		if howling.finished:
			...
			get_wolf.play()
		WolfData.set_Alaskan_Tundra_Wolf_Rescue_Status(true)
		#Image
		...
		get_tree().change_scene_to_packed(alaskan_tundra_wolf_almanac)
		get_tree().root.add_child(alaskan_tundra_wolf_almanac)
