...
var labrador_wolf_almanac = preload("res://Assets/Scences/UI/Wolf_Almanac/Book/British Colombian Wolf/britsh_colombian_wolf_almanac.tscn").instantiate()
...
func _on_area_2d_body_entered(body):
	if body as Players:
		...
		if howling.finished:
			...
			get_wolf.play()
		WolfData._set_Labrador_Wolf_Rescue_Status(true)
		#Image
		...
		#Conservation Status
		almanac.setter_Wolf_Conservation_Status(WolfData._get_Labrador_Wolf_Conservation_Status())
		#Region
