...
var himalayan_wolf_almanac = preload("res://Assets/Scences/UI/Wolf_Almanac/Book/Himalayan Wolf/himalayan_wolf_almanac.tscn").instantiate()
...
func _on_area_2d_body_entered(body):
	if body as Players:
		...
		if howling.finished:
			...
			get_wolf.play()
		WolfData._set_Himalayan_Wolf_Rescue_Status(true)
		#Image
		...
		get_tree().change_scene_to_packed(himalayan_wolf_almanac)
		get_tree().root.add_child(himalayan_wolf_almanac)
