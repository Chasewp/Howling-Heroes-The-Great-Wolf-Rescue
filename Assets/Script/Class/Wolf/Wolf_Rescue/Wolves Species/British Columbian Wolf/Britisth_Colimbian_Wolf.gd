class_name British_Colombian_Wolf
...
var british_colombian_wolf_almanac = preload("res://Assets/Scences/UI/Wolf_Almanac/Book/British Colombian Wolf/britsh_colombian_wolf_almanac.tscn").instantiate()
...
func _on_area_2d_body_entered(body):
	if body.is_in_group("player"):
		...
		if howling.finished:
			...
			get_wolf.play()
		WolfData._set_British_Columbian_Wolf_Rescue_Status(true)
		#Image
		...
		#Conservation Status
		almanac.setter_Wolf_Conservation_Status(WolfData._get_British_Columbian_Wolf_Conservation_Status())
		#Region
		...
		get_tree().change_scene_to_packed(british_colombian_wolf_almanac)
		get_tree().root.add_child(british_colombian_wolf_almanac)
